class SalesforceOrg < ActiveRecord::Base
  ...
  attr_encrypted :password, :attribute => 'password_encrypted', :key => SingletrackMonitor::Application.config.db_encryption_key
  attr_encrypted :token,    :attribute => 'token_encrypted',    :key => SingletrackMonitor::Application.config.db_encryption_key
